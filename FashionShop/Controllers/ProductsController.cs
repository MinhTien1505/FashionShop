...
namespace FashionShop.Controllers
{
    ...
    {
        private FashionShopEntities1 db = new FashionShopEntities1();
        ...
        public ActionResult Create([Bind(Include = "id,Name,Price,Image,Description,Category")] Product product)
        {
            ...
            catch(DbEntityValidationException ex)
            {
                ...
                {
                    foreach(var validationError in erros.ValidationErrors)
                    {
